...
export default function FounderPage() {
  ...
  const judges = [
    ...
    },
    {
      ...
      description: "Stephen Camilleri is a globally experienced entrepreneur, advisor, and capital connector, he has spent his career supporting founders in building, scaling, and funding businesses across five continents. His work is driven by a clear mission which is to back bold entrepreneurs, foster cross border collaboration, and help transform strong ideas into sustainable, high impact ventures. He specialize in opening doors for visionary founders strengthening their brands, refining their strategies, and connecting them with capital through an established international network of investors. Over the past three years, his focus has been on expanding his global network and deepening his understanding of how businesses operate across diverse markets, including the UK, Europe, Africa, and the United States. This has given him first hand insight into the challenges, opportunities, and cultural nuances that shape entrepreneurial success in different regions. He is actively engaged in sectors including AI, film, fashion, events, energy, and entrepreneurship ecosystems, with a particular passion for innovation hubs and founder led communities. Alongside his commercial work, mentoring and supporting entrepreneurs has been a consistent thread throughout his career. As a collaborative and people driven leader, he is committed to sharing real-world experience to help others flourish. As a judge, he brings a practical, global, and founder first perspective assessing ideas not only on creativity, but on scalability, execution, and long term impact.",
    ...
    },
    {
      ...
      description: "OUSSEINI OUMAROU is a highly motivated Cloud and AI Consultant, uniquely positioned with a strong foundation in both Cloud computing and Artificial Intelligence. His expertise is validated by industry leading certifications. This robust skill set, combined with his background in Cryptocurrency, Web3, and Blockchain, allows him to architect and deploy innovative, scalable, and secure cloud native solutions, with a particular focus on leveraging advanced AI capabilities to drive transformative business outcomes. He is dedicated to pushing the boundaries of technology to create intelligent systems that redefine possibilities.",
      photo: "/judges/ousseini-oumarou.jpg"
    },
    {
      name: "Fisayo Areo",
      title: "Founder and CEO of signature puffs",
      description: "Fisayo Areo is a seasoned Confiseur/ pastry chef and the founder of signature puff which is a UK based pastry brand celebrating culture, flavour and community through freshly prepared West African comfort food. The brand is built on a passion for quality, consistency and creating pastries welcoming to all. She also continue to expand its menu with well loved favorites suitable for all.",
